...
int main() {
	...
	for( int i = 0; i < 6; i++ ) {
		switch(i){
			case 0 : 
				data = { 0, 1, 2, 3, 4, 5 }; // 출력할 문자 데이터				
				break;
			case 1:
				data = { 1, 2, 3, 4, 5,0 }; // 출력할 문자 데이터
				break;  
			case 2:
				data = { 2, 3, 4, 5, 0, 1 }; // 출력할 문자 데이터
				break;
			case 3:
				data = { 3, 4, 5, 0, 1, 2 }; // 출력할 문자 데이터
				break;  
			case 4:
				data = { 4, 5, 0, 1, 2, 3 }; // 출력할 문자 데이터
				break;  
			case 5:
				data = { 5, 0, 1, 2, 3, 4 }; // 출력할 문자 데이터
				break;  
			default :
				data = { 0, 1, 2, 3, 4, 5 }; // 출력할 문자 데이터
				break;
